async function GetTheRegionOfDendroparkStudyExcursions() {
    const response = await fetch("/api/TheRegionOfDendroparkStudyExcursions", {
        method: "GET",
        headers: {
...
function row(request) {
    ...
    removeLink.setAttribute("data-id", request['Номер региона']);
...
GetTheRegionOfDendroparkStudyExcursions();