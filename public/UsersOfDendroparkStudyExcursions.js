async function GetUsersOfDendroparkStudyExcursions() {
    const response = await fetch("/api/UsersOfDendroparkStudyExcursions", {
        method: "GET",
        headers: {
...
function row(request) {
    ...
    editLink.setAttribute("data-id", request['ID']);
    ...
    removeLink.setAttribute("data-id", request['ID']);
...
GetUsersOfDendroparkStudyExcursions();